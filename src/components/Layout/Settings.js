        ...
        <Container>
          <Row>
            <Col xl={4} lg={6} md={8} sm={10} xs={12} className="mx-auto">
              ...
              <Card><Card.Body><Card.Text className="text-center">email: {user.email}</Card.Text><Card.Text className="text-center">username: {user.name}</Card.Text><Card.Text className="text-center"><Link to='/change-password'>Change Password</Link></Card.Text></Card.Body></Card>
            </Col>
          </Row>
        </Container>
        <span>{jsx}</span>
